...
1. Open TermProjectMain.py and run the file
2. Click Play
3. Choose your gamemode. (1 player or 2 players)
4. Select a song using 'Select another song'. You can choose any song you wish, as long as you have the .wav file for your song! The default .wav file displayed is fancy.wav
5. Click Play Now!
...
Commands:
1 Player: 
Player 1 - Left and right arrow keys to move, SPACE bar to hit a circle
2 Players: 
Player 1 - Left and right arrow keys to move, UP arrow to hit a circle
Player 2 - A and D keys, W key to hit a circle
